...
export default Vue.extend({
  ...
  methods: {
    ...
    async fetchProcessRuleSets(country: ICountry): Promise<void> {
    ...
    makeProcessRuleSetTdAttrs(): Record<string, (prs: ICase) => void> {
      return {
    ...
    durationRuleTdAttrs(
      ...
      const processRuleSet = row.process as unknown as IProcessRuleSet;
