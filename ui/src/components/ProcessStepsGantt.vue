...
export default Vue.extend({
  components: { Gantt },
  props: { process: Object as PropType<IProcessRuleSet>, editable: Boolean },
...
export function makeTask(step: IProcessStep): Task {
  var title;
