# Generated by Django 3.2 on 2021-04-30 14:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issued_documents', models.ManyToManyField(blank=True, help_text='Issued documents associated with this process.', through='immigration.IssuedDocument', to='immigration.IssuedDocumentType')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estimated_duration_min', models.PositiveIntegerField(help_text='Minimum number of days this step is expected to take')),
                ('estimated_duration_max', models.PositiveIntegerField(help_text='Maximum number of days this step is expected to take')),
        ...
        migrations.AddField(
            model_name='issueddocument',
            name='process',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='immigration.process'),
        ),
        ...
        migrations.AddConstraint(
            model_name='processstep',
            constraint=models.UniqueConstraint(fields=('process', 'sequence_number'), name='imm__process_step__sequence_number__uniq'),
        ),
        migrations.AddConstraint(
            model_name='process',
