    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', django_fsm.FSMField(default='FREE', max_length=50, protected=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='case',
            name='client_contact',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='client.clientcontact'),
        ),
        migrations.AddField(
