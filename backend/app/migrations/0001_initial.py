    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('associated_object_content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
        ...
        migrations.AddField(
            ...
            name='process',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='steps', to='app.process'),
        ),
        migrations.AddField(
            model_name='processstep',
            name='service',
        ...
        migrations.AddField(
            model_name='process',
            name='home_country',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='app.country'),
        ),
        migrations.AddField(
            model_name='process',
            name='nationality',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='app.country'),
        ),
        migrations.AddField(
            model_name='process',
            name='route',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='processes', to='app.route'),
        ),
        migrations.AddConstraint(
            model_name='country',
